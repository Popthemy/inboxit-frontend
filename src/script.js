// inboxIT Landing Page JavaScript
...
function updateFormPreview() {
  ...
  // Generate form HTML
  let formHTML =
    '<form action="https://api.inboxIT.com/submit" method="POST" class="preview-form">\n';
  ...
  const buttonClass =
    formConfig.buttonStyle === "primary"
      ? "btn-primary"
      : formConfig.buttonStyle === "secondary"
        ? "btn-secondary"
        : "btn-accent";
...
const templates = {
  contact: `<form action="https://api.inboxIT.com/submit" method="POST">
  <input type="text" name="name" placeholder="Your Name" required>
  <input type="email" name="email" placeholder="Your Email" required>
  ...
  newsletter: `<form action="https://api.inboxIT.com/submit" method="POST">
  <input type="email" name="email" placeholder="Enter your email" required>
  <input type="hidden" name="type" value="newsletter">
  <button type="submit">Subscribe</button>
</form>`,

  quote: `<form action="https://api.inboxIT.com/submit" method="POST">
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll("form").forEach((form) => {
    form.addEventListener("submit", function (e) {
      e.preventDefault();
      alert(
        "This is a demo form. In production, submissions would be sent to your email via inboxIT!",
      );
    });
  });
});
